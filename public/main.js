document.querySelectorAll(".deleteBtnI").forEach((element) => {
  element.addEventListener("click", (e) => {
    ...
    let name =
      e.target.parentElement.parentElement.children[0].innerText.toLowerCase();
    console.log(
...
// });
// setTimeout(() => {
//   document.querySelectorAll(".tierRow").forEach((tier) => {
//     tier.addEventListener("mouseup", (event) => {
